...
- Usos básicos: desplegar o seleccionar el texto (resaltar) para traducir.
...
- Si <KBD> Right-Alt </ kbd> se usa como Swap Hangul,
Use otra clave para trabajar.

! [resultado] (/doc/11.gif)

- Traducir el texto del cuadro de búsqueda de URL escribiendo <kbd>/</ kbd>+<kbd> espacio </ kbd> antes de su consulta.

! [resultado] (/doc/21.gif)

- Admitir PDF en línea para mostrar información de herramientas traducida usando PDF.JS (el archivo PDF de computadora local necesita permiso adicional, consulte [Excepción] (https://github.com/ttop32/mousetooltiptranslator/blob/main/doc/intro.md#exception)))
...
- Ejecute la tecla Auto Reader por Press <KBD> F2 </KBD>
- Comienza a leer el mouse a través del texto hasta el final con TTS
- Para detener el lector automático, presione <KBD> ESC </KBD>
- Pruebe Double Presione <KBD> F2 </KBD> Para escuchar el texto de texto traducido lector automático
...
-Solo compatible con los navegadores basados ​​en el cromo, como Google Chrome, MS-Edge, Vivaldi, Opera, Brave, ARC y Yandex.
...
# Cambiar el idioma
- Cambiar el idioma actual en la página Configuración
