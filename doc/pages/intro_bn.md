...
- বেসিক ব্যবহারগুলি: অনুবাদ করার জন্য পাঠ্য ওভার বা নির্বাচন করুন (হাইলাইট)।
...
- পরীক্ষা করুন [ভাষা কীভাবে পরিবর্তন করবেন] (https://github.com/ttop32/mousetooltiptranslator/blob/main/doc/intro.md#change-ganganage)
- উত্স এবং লক্ষ্য ভাষাগুলি অভিন্ন হলে এই অনুবাদক পাঠ্যটি বাদ দেবেন।

! [আল্ট পাঠ্য] (/ডক/রিগ্রে.জিফ)

- কোনও সরঞ্জামদণ্ড প্রদর্শিত হলে টিটিএস উচ্চারণটি শুনতে <কেবিডি> বাম-সিটিআরএল </কেবিডি> কীটি ধরে রাখুন। ভয়েস বন্ধ করতে <কেবিডি> ইএসসি </কেবিডি> টিপুন।
- অনুবাদকৃত ফলাফলের পাঠ্য শুনতে ডাবল প্রেস <কেবিডি> বাম-সিটিআরএল </কেবিডি> চেষ্টা করুন
! [ফলাফল] (/ডক/20.gif)
...
- যদি অনুবাদটি কাজ না করে তবে আপনার বর্তমান লক্ষ্য ভাষাটি আপনার লেখার ভাষার সাথে মেলে তা নিশ্চিত করুন।
- যদি <কেবিডি> ডান-আল্ট </কেবিডি> হ্যাঙ্গুল অদলবদল হিসাবে ব্যবহার করা হয়,
সাথে কাজ করতে অন্যান্য কী ব্যবহার করুন।

! [ফলাফল] (/ডক/11.gif)

- আপনার প্রশ্নের আগে <কেবিডি>/</kbd>+<কেবিডি> স্পেস </কেবিডি> টাইপ করে ইউআরএল অনুসন্ধান বাক্স পাঠ্যটি অনুবাদ করুন।

! [ফলাফল] (/ডক/21.gif)

- পিডিএফ.জেএস ব্যবহার করে অনুবাদ করা টুলটিআইপি প্রদর্শন করতে অনলাইন পিডিএফ সমর্থন করুন (স্থানীয় কম্পিউটার পিডিএফ ফাইলের অতিরিক্ত অনুমতি প্রয়োজন, দেখুন [ব্যতিক্রম] (https://github.com/ttop32/mousetooltiptranslator/blob/main/intro.md#exception))
...
- <কেবিডি> বাম-শিফ্ট </kbd> কী + মাউসকে একটি চিত্রের উপর ধরে রাখার সময় ওসিআর প্রক্রিয়া করুন (উদাঃ, মঙ্গা)

! [ফলাফল] (/ডক/15.gif)

- <কেবিডি> এফ 2 </কেবিডি> কী টিপুন অটো রিডার চালান
...
-কেবল ক্রোমিয়াম-ভিত্তিক ব্রাউজারগুলির সাথে সামঞ্জস্যপূর্ণ, যেমন গুগল ক্রোম, এমএস-এজ, ভিভালডি, অপেরা, সাহসী, আর্ক এবং ইয়ানডেক্স।
- শর্টকাট কী কাস্টমাইজ করুন
- ক্রোম থেকে: // এক্সটেনশনস/শর্টকাটস বা সমমানের ব্রাউজার অভ্যন্তরীণ কনফিগারেশন পৃষ্ঠা, ক্রোম: // আপনার ব্রাউজারের অভ্যন্তরীণ ইউআরএল (যেমন, প্রান্ত: //, ব্রাউজার: //, বা সাহসী: // ইত্যাদি) দিয়ে প্রতিস্থাপন করে অ্যাক্সেসযোগ্য।
# ভাষা পরিবর্তন করুন
- সেটিং পৃষ্ঠায় বর্তমান ভাষা পরিবর্তন করুন
...
- ওয়েব স্থিতি অফলাইন থাকলে অ্যাপ্লিকেশনটি কাজ করবে না।
- যদি সাইটটি <https://chrome.google.com/extensions> হয় তবে এটি ক্রোম সুরক্ষার কারণের কারণে কাজ করে না।
- যদি কোনও স্থানীয় ফাইলের অনুমতি না দেওয়া হয় তবে স্থানীয় পিডিএফ পরিচালনা করা যায় না।
