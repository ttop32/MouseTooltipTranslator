...
- `#204` (2025-02-21) — 단축키로 원문 복사 — [link](https://github.com/ttop32/MouseTooltipTranslator/issues/204) — ✅ **적용됨** (기존 `copy-translated-text`(Ctrl+Shift+6)는 번역문만 복사 → 원문 복사용 `copy-source-text`(Ctrl+Shift+7) 명령 + 우클릭 "Copy original" 메뉴 추가. `background.js` recentSource 저장, manifest(크롬/파폭) commands 등록. 복사 범위(단어/문장/컨테이너)는 현재 mouseoverTextType 감지 모드를 따름)
