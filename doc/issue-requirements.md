...
- `#186` (2024-11-26) — 입력 중 번역 텍스트 표시 비활성 옵션 — [link](https://github.com/ttop32/MouseTooltipTranslator/issues/186) — ✅ **적용됨** (설정 `mouseoverWhileWriting`=Off 시 입력창(input/textarea/contenteditable) 포커스 중 mouseover 툴팁 억제. `contentScript.js` `isTooltipSuppressedWhileWriting`)
