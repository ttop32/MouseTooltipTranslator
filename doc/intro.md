...
![result](/doc/11.gif)
- Support online pdf to display translated tooltip using PDF.js (local computer pdf file need aditional permission, see [exception](https://github.com/ttop32/MouseTooltipTranslator/edit/main/doc/intro.md#exception))
![result](/doc/12.gif)
