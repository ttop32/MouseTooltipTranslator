...
- 0.1.225
  ...
  - Hide the mouseover tooltip while a text box is focused so it no longer obscures typing (default); re-enable it with the "Show Tooltip While Typing" option (#186)
