...
i18List = [
    ...
    "On Hover",
    "On Select n Hover",
    "Select group to play",
    "No Group Selected",
    "Check groups to play",
    "Flashcard makes cards from your saved words",
    "Flashcard",
    "Play Flashcard",
    "Reset progress",
    "No History Data",
    "Today play is completed",
    "Try on next day",
    "No more card to learn today",
    "Add more history data to play with",
    "Finish",
    "Today Flashcards are Completed",
    "No More Card Data",
    "Show Answer",
    "Again",
    "Hard",
