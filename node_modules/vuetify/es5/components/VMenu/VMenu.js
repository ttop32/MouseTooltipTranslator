...
var baseMixins = (0, _mixins.default)(_dependent.default, _delayable.default, _detachable.default, _menuable.default, _returnable.default, _roundable.default, _toggleable.default, _themeable.default);
/* @vue/component */
...
var _default = baseMixins.extend({
  ...
  methods: {
    ...
    genActivatorAttributes: function genActivatorAttributes() {
      var attributes = _activatable.default.options.methods.genActivatorAttributes.call(this);
    ...
    genContent: function genContent() {
      ...
      var options = {
        ...
        class: _objectSpread({}, this.rootThemeClasses, {}, this.roundedClasses, _defineProperty({
  ...
  render: function render(h) {
    ...
    return h('div', data, [!this.activator && this.genActivator(), this.showLazyContent(function () {
      return [_this7.$createElement(_VThemeProvider.VThemeProvider, {
        props: {
          root: true,
          light: _this7.light,
          dark: _this7.dark
